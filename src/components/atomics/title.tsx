const getTitleStyle = (section: string) => {
  switch (section) {
    case "hero-white":
      return "text-2xl leading-9 text-white text-center";
    case "white-left":
      return "text-2xl leading-9 text-white text-left";
    case "white-subtitle":
      return "text-xl leading-9 text-white text-center";
    case "hero":
...
const getSubtitleStyle = (section: string) => {
  switch (section) {
    case "hero":
      return "text-lg leading-8 text-white";
    case "hero-white":
      return "text-lg leading-8 text-subtitle";
    case "header":
...
function Title({
  ...
  return (
    <div
      ...
      className="flex data-[reverse=false]:flex-col data-[reverse=true]:flex-col-reverse data-[reverse=true]:text-right"
    >
      <h1 className={`font-bold text-secondary ${getTitleStyle(section)}`}>
        {title}
      </h1>
      <h2 className={getSubtitleStyle(section)}>{subtitle}</h2>
    </div>
  );
}
